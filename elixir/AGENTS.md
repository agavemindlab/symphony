...
- Runtime config is loaded from a `WORKFLOW.md` path via `SymphonyElixir.Workflow` and `SymphonyElixir.Config`.
...
- `../workflows/` for centralized workflow/config contract changes.
