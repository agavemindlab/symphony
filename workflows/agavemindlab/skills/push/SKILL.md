...
7. Request code review per the project's reviewer configuration:
   ...
   - Record the request timestamp and head SHA in the Linear workpad.
   ...
   - If automated review does not arrive before the timeout, do not block
     ...
     workpad and make the final Linear `## Review Handoff` ask for human PR
     review with `风险/注意` noting the missing automated review result.
