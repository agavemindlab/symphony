...
- Base: `<base branch/ref and sha; omit for no-PR Spike>`
- Merge state: `<CLEAN / DIRTY / UNKNOWN; omit for no-PR Spike>`
- CI / checks: `<workflow/check>` <passed|failed|pending|omit for no-PR Spike>
